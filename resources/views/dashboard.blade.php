...
<div class="content-grid">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="action-btns">
                <a href="{{ route('attendance.timeline') }}" class="btn btn-secondary btn-sm">{{ __('messages.timeline') ?? 'Timeline' }}</a>
                <a href="{{ route('attendance.index') }}" class="link">{{ __('messages.view_all') }} →</a>
            </div>
        </div>
        <div class="card-body">
    ...
    <div class="card" style="height: fit-content;">
        ...
        <div class="card-body">
            <a href="{{ route('devices.create') }}" class="quick-action">
            ...
            <a href="{{ route('admin.shifts.index') }}" class="quick-action">
                <div class="quick-action-icon">📅</div>
